...
export const pinPairingConfirmSchema = z.object({
  body: z.object({
    vehicleId: z.union([
      ...
      z
        .string()
        .regex(/^\d+$/, "Vehicle ID must be numeric")
        .transform((value) => Number(value)),
    ]),
    pin: z
      .string()
      .regex(/^[A-Z0-9]{6}$/, "PIN must be 6 alphanumeric characters"),
  }),
});
...
export const vehicleRegisterSchema = z.object({
  ...
  body: z.object({
    pairingToken: z.string().uuid("pairingToken must be a valid UUID"),
  }),
});
  ...
  vehicleCertificateSchema: z.object({
    body: z.object({
      ...
      validityDays: z
        ...
        .max(3650, "Maximum validity is 10 years")
        .optional(),
    }),
  }),
  ...
  digitalKeyCertificateSchema: z.object({
    body: z.object({
      ...
      validityDays: z
        .number()
        .positive("Validity days must be positive")
        .max(365, "Maximum validity is 1 year")
        .optional(),
    }),
  }),
